...
count_inverse_tau(1, 100,  8) == 10     or die "error";
count_inverse_tau(1, 1000, 8) == 180    or die "error";
count_inverse_tau(1, 1e6,  8) == 224427 or die "error";

say count_inverse_tau(1, 1e12, 8);
